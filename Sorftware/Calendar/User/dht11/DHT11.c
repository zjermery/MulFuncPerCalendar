...
//    oled_ShowNum(16*3-8,2*1,dht11Data.temp_int,2,16);
//    oled_ShowString(16*4-8,2*1,(u8 *)".",16);
//    oled_ShowNum(16*4,2*1,dht11Data.temp_deci,1,16);

//    oled_ShowNum(16*3-8,2*2,dht11Data.humi_int,3,16);
    //	oled_ShowString(16*4-8,2*2,(u8 *)".",16);
    //	oled_ShowNum(16*4,2*2,dht11Data.humi_deci,1,16);
    //	oled_ShowString(16*5-8,2*2,(u8 *)"%",16);
